...
from config import root_dir, num_epochs, batch_size, embedding_dim, learning_rate, l2, gamma, milestones
...
train(model, optimizer, scheduler, train_loader, val_loader, device, args)
visual_analysis(model, test_loader, device, args)